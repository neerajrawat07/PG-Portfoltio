...
<section class="sec--tight relative overflow-hidden border-y border-ink-line bg-paper-soft">
    <div class="pointer-events-none absolute left-1/2 top-1/2 h-[22rem] w-[44rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-electric-violet/10 blur-[120px]" aria-hidden="true"></div>
